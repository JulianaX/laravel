...
<div class="panel panel-primary @role('admin', true) panel-info  @endrole">
    ...
    <div class="panel-body">
        ...
        <p>
            <iframe src="https://ghbtns.com/github-btn.html?user=dbmigration&repo=laravel-auth&type=star&count=true" frameborder="0" scrolling="0" width="170px" height="20px" style="margin: 0px 0 -3px .5em;"></iframe>
        </p>
